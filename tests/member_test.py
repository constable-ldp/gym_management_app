...
class TestMember(unittest.TestCase):
    ...
    def setUp(self):
        self.member = Member('John', 'Smith', 'johnsmith@gmail.com', '07595964019', str(datetime.date(1997, 5, 17)), True, False)
    ...
    def test_member_has_date_of_birth(self):
        self.assertEqual('1997-05-17', self.member.date_of_birth)
